...
export const WithValue: StoryObj<MutationCooccurrenceGridTooltipProps> = {
    args: {
        pattern: { symbols: { '[123]': 'A', '[124]': 'T', '[126]': 'G' } },
...
export const WithUncoveredPosition: StoryObj<MutationCooccurrenceGridTooltipProps> = {
    args: {
        pattern: { symbols: { '[123]': null, '[124]': 'T', '[126]': null } },
        positions: defaultPositions,
        date: weekDate,
