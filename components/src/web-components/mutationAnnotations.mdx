...
In this example, hovering `ORF1a:T2343C` shows `3CLpro:T31C` as the title and the specific description, hovering `ORF1a:G2558A` shows `3CLpro:E166K` but falls back to the group description, and hovering `ORF1a:C2566T` falls back to both the group name and description.
