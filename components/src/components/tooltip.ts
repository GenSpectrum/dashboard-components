// This is adapted from the lit tutorial:
// https://lit.dev/tutorials/tooltip/#10
...
export class SimpleTooltip extends LitElement {
    ...
    set target(target: Element | null) {
        ...
        if (target) {
            ...
            enterEvents.forEach((name) => target!.addEventListener(name, this.toggle));
